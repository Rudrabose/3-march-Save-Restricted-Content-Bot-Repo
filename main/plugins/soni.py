    ...
    async with gagan.conversation(event.chat_id) as conv: 
        if not s:
            ...
            cd = await conv.send_message("**Batch process ongoing...**\n\nProcess completed: ", 
                                    buttons=[[Button.url("Join Channel", url="https://t.me/ARJUNALECTURES2025")]])
            ...
            if int(fw.value) > 300:
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="https://t.me/ARJUNALECTURES2025")]])
        except Exception as e:
            #print(e)
            logger.info(e)
...
TEXT = "👋 Hi, This is 'Paid Restricted Content Saver' bot Made with ❤️ by __**Joseph Davidson**__."
...
async def start_command(event):
    ...
    buttons = [
        [Button.inline("Cancel", data="cancel"),
         Button.inline("Cancel", data="cancel")],
        [Button.url("Join Channel", url="https://telegram.dog/ARJUNALECTURES2025")]
    ]
